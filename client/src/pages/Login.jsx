...
const Login = () => {
  ...
  return (
    <div className="relative min-h-screen flex items-center justify-center bg-black overflow-hidden px-4">
      ...
      >
        <div className="bg-black/80 flex flex-col items-center backdrop-blur-xl rounded-2xl p-8 text-white shadow-2xl">
        <Link to="/">
          ...
          <form className="space-y-5">
            ...
            {/* FORGOT */}
            <div className="text-right text-sm text-gray-400 hover:text-purple-400 cursor-pointer">
              Forgot Password?
            </div>
